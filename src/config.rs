...
pub const RENDEZVOUS_SERVERS: &[&str] =  &["rustdesk.net-g.cn"];   // &["rs-ny.rustdesk.com"];
pub const RS_PUB_KEY: &str = "OeVuKk7081iXp+APNn0Y3pC1Iwpwn44JGqrQCsWqmBw="; // "OeVuKk5nlHiXp+APNn0Y3pC1Iwpwn44JGqrQCsWqmBw=";
